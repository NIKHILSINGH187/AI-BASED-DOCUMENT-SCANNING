    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 px-4">
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in-up">
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-slate-500">Create your verification officer account</p>
        </div>

        <div className="glass-panel p-8">
          {success ? (
            <div className="flex animate-fade-in flex-col items-center gap-4 py-8">
              <CheckCircle2 className="h-12 w-12 animate-glow-pulse text-emerald-500" />
            ...
            <>
              ...
              <p className="mt-1 text-sm text-slate-500">Register as a verification officer</p>
              ...
              <p className="mt-6 text-center text-sm text-slate-500">
                ...
                <Link to="/login" className="font-medium text-cyan-600 transition-colors hover:text-cyan-700">
                  Sign in
                </Link>
              </p>
            </>
